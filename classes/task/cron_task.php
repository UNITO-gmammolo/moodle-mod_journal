 ...
 *
 * @package    mod_journal
 * @copyright  2016 David Monllao {@link http://www.davidmonllao.com}, Rabellino Sergio, Mammolo Giuseppe
...
use context_module;
/**
 * The main schedule task for the journal module.
 *
 * @package   mod_journal
 * @copyright  2016 David Monllao {@link http://www.davidmonllao.com}, Rabellino Sergio, Mammolo Giuseppe
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class cron_task extends \core\task\scheduled_task {
    ...
    public function execute() {
        ...
        if ($entries = $this->journal_get_unmailed_graded($cutofftime)) {
            
            $usernamefields = \core_user\fields::get_name_fields();
            $requireduserfields = 'id, auth, mnethostid, email, mailformat, maildisplay, lang, deleted, suspended, username, '
    ...
    private function journal_get_unmailed_graded($cutofftime) {
        global $DB;
